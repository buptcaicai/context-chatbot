...
def send_to_kafka(file_name: str, file_size: int, sentences, is_last: bool, topic="file-injest"):
    ...
    file_content = FileContent(file_name=file_name, file_size=file_size, sentences=sentences, is_last=is_last)
        ...
        while True:
            ...
            if not chunk:
                ...
                if buffer:
                    ...
                    send_to_kafka(file_name, file_size, sentences_cache, is_last=True)
                    sentences_cache = []
                break
